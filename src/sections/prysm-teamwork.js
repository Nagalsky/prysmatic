...
export default function PrysmTeamWork({nested, ...restProps}) {
  console.log('nested', nested)
  return (
    <section
      className={`${
        nested ? 'md:py-24' : 'md:py-16'
      ...
      <div className={`${!nested ? 'container' : ''}`}>
        <div className="grid md:grid-cols-[35%_1fr] gap-10 xl:gap-16 md:items-center">
          ...
          <div className="space-y-[20px] md:space-y-[40px]">
            <h3
              className={`${
                !nested ? 'text-purple-600 dark:text-sky-600' : ''
            ...
            >
              ...
              <span className="block">
                ...
                <span
                  className={`${
                    nested ? 'bg-white' : 'bg-dark-500 dark:bg-semi-white'
