    ...
    >
      <div className="container flex items-center gap-4 lg:gap-16 xxl:gap-[268px]">
        ...
        <button
          ...
          type="button"
          className="inline-flex lg:hidden items-center justify-center rounded-full border border-yellow-600 bg-yellow-500 w-8 h-8 ml-auto text-dark-500"
        >
          {isOpened ? (
            <svg
              width="32"
